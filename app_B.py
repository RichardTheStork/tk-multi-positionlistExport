...
wtd_pipeline = tank.platform.import_framework("tk-framework-wtd", "pipeline")
...
def retrieveDataFromSelection(allTypes = None, allParents = None):
	...
	for obj in selected:
		...
		tempOutput = getObjectData(obj, parents = parents, assetType = assetType)
		transformDataDict[tempOutput["name"]] = tempOutput
...
def getObjectData(object, parents = [], assetType = None):
	...
	return wtd_pipeline.setAssetDict(name, longName, asset, assetType, animated, position, rotation, scale, parents)
